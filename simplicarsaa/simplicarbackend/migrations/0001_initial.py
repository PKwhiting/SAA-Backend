    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('odometer_brand', models.CharField(blank=True, choices=[('ACTUAL', 'ACTUAL'), ('EXEMPT', 'EXEMPT'), ('NOT ACTUAL', 'NOT ACTUAL'), ('INOPERABLE', 'INOPERABLE'), ('OTHER', 'OTHER')], max_length=100)),
                ...
                ('vehicle_zip', models.CharField(blank=True, max_length=10)),
                ...
                ('title_classification', models.CharField(choices=[('CLEAN', 'CLEAN'), ('SALVAGE', 'SALVAGE'), ('REBUILT', 'REBUILT'), ('EXPORT ONLY', 'EXPORT ONLY'), ('PARTS ONLY', 'PARTS ONLY'), ('OTHER', 'OTHER')], default='CLEAN', max_length=100)),
                ('title_note', models.CharField(blank=True, max_length=100)),
        ...
        migrations.AddField(
            model_name='car',
            name='state',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='simplicarbackend.state'),
        ),
        migrations.CreateModel(
            name='Bid',
            fields=[
